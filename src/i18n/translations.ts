...
const translations = {
  fr: {
    ...
    footer: {
      ...
      links: ['Nos écoles', 'Nos menus', 'Contactez-nous', 'Gestion des données', 'Notre politique en matière de gestion des données'],
  ...
  en: {
    ...
    footer: {
      ...
      links: ['Our Schools', 'Our Menus', 'Contact Us', 'Data Management', 'Our Data Management Policy'],
